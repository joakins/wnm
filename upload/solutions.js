        ...
        const solutionsData = {
            ...
            //MARINAS & WORKING HARBOURS
            'floating-pontoon': {
                title: 'Floating Pontoon Jetties',
                subtitle: 'Flexible floating access solutions for marine environments',
                overview: 'Floating pontoon jetties are advanced marine access systems designed to provide stable and secure docking solutions for waterfront facilities. They are widely used in marinas, working harbours, waterfront developments, and recreational marine environments. <br> <br> Engineered for durability and flexibility, these systems adapt to changing water levels while maintaining structural stability. Their modular construction allows easy customization, making them ideal for commercial, industrial, and leisure marine applications requiring reliable and long-lasting performance.',
                image: 'images/solutions/FloatingPontoonJetties.jpg',
                features: [
                    { 
                        icon: 'fa-solid fa-city', 
                        title: 'Water Level Adaptability', 
                        desc: 'Designed to rise and fall with changing water levels, ensuring safe and convenient access regardless of tides or fluctuating marine conditions.' 
                    },
                    { 
                        icon: 'fa-solid fa-people-arrows', 
                        title: 'Corrosion Resistant Materials', 
                        desc: 'Manufactured using durable, marine-grade materials resistant to rust, moisture, and saltwater exposure, extending lifespan in harsh coastal environments.' 
                    },
                    { 
                        icon: 'fa-solid fa-tree', 
                        title: 'Modular Construction', 
                        desc: 'Flexible modular systems allow easy expansion, customization, and reconfiguration to meet varying marina or harbour operational requirements efficiently.' 
                    },
                    { 
                        icon: 'fa-solid fa-chart-line', 
                        title: 'High Structural Stability', 
                        desc: 'Provides a secure and stable platform for docking, loading, and pedestrian movement, even under demanding marine conditions and heavy usage.' 
                    },
                    { 
                        icon: 'fa-solid fa-code-branch', 
                        title: 'Low Maintenance Requirements', 
                        desc: 'Engineered for long-term durability with minimal upkeep, reducing maintenance costs while maintaining operational reliability and appearance.' 
                    },
                    { 
                        icon: 'fa-solid fa-chart-simple', 
                        title: 'Enhanced Safety Features', 
                        desc: 'Integrated anti-slip surfaces and secure mooring systems improve safety for users, vessels, and operational activities in marine environments.' }
                ],
                benefits: [
                ...
                related: [
                    { 
                        title: 'Cyber Lock', 
                        desc: 'CyberLock is an innovative, robust, electronic cylinder that easily converts mechanical locks', 
                        image: 'images/solutions/cyberLock.jpg',
                        link: 'solutionDetail.html?id=lock-cyber' 
                    },
                    { 
                        title: 'GRP Profiles', 
                        desc: 'Customizable structural profiles for versatile construction applications', 
            ...
            'lock-cyber': {
                title: 'Cyber Lock',
                subtitle: 'CyberLock is an innovative, robust, electronic cylinder that easily converts mechanical locks',
                overview: 
                [
                    'CyberLock is an innovative, robust, electronic cylinder that easily converts mechanical locks into an easy to install access control system, with over 350 lock designs available. No wiring is needed, as power is provided by the battery in the key. <br><br> They also have no keyway and hence cannot be picked. <br> <br>', 
                    'With no inner keyway, CyberLock cylinders are ideal for outdoor operations, preventing exposure to environmental pressures such as moisture and dirt. For high security installations, drill resistant cylinders are available, such as used in the CEN6 padlocks.<br> <br>',
                    'One Key... Many Locks...<br> <br>',
                    'At the heart of the CyberLock system is the highly intelligent CyberKey, which unlike traditional keys, cannot be duplicated. Each key is encoded with a unique ID, and carries a defined schedule for the key holder. The schedule highlights the locks the key holder can access, and the date and time to allow entry. In addition, CyberKeys can also be issued with a date to begin working, and a date to automatically expire, limiting the risk of a lost key!<br> <br>',
                    'A record of all events is stored in both the locks and the keys. The key stores up to 3,900 of the most recent access events, and the lock stores the most recent 1,100 access events. In addition, the key has a battery that is used to provide power and a clock chip that is used to keep and record time.<br> <br>',
                    '<strong>CyberKey Communicators </strong> <br>',
                    'Communicators are used for communication between CyberKeys and the Management Software platforms. The communicators available depend upon the software installed and the requirements of the CyberLock installation.<br> <br>',
                    'Using CyberLock and its advanced management platform called Enterprise; you can program keys with your specific instructions and download their history from almost anywhere! This includes options such as local at the PC using a USB download station, across large geographic areas using a PIN Code Authoriser and remotely using a PDA or Blackberry.<br> <br>',
                    '<strong>Enterprise Management Software (CyberAudit-Web) </strong> <br>',
                    'CyberAudit-Web is a comprehensive, feature-rich, enterprise software ideal for large, widespread businesses. It has the benefit of being easy to administer and use although select administrators have to be trained in handling the various authorisation roles that may be necessary (such as contactor control, or issuing keys to new staff).<br> <br>',
                    'The Enterprise server provides significant capacity: systems of 15,000 locks, 15,000 keys, and 500 concurrent users can be easily managed within a single Enterprise server. Full specification details are available on request.<br> <br>',
                    '<br> <br>',
                ], 
                image: 'images/solutions/cyberLock.jpg',
                features: [
                    { 
                        icon: 'fa-solid fa-city', 
                        title: 'Circuit Board with Processor', 
                        desc: 'Integrated intelligent processor enhances security operations, manages access permissions efficiently, and ensures reliable communication between locking components for improved system performance and operational control.' 
                    },
                    { 
                        icon: 'fa-solid fa-people-arrows', 
                        title: 'Unique ID', 
                        desc: 'Each lock and key is assigned a unique identification code, preventing duplication while improving accountability, traceability, and secure user authentication across the entire access control system.' 
                    },
                    { 
                        icon: 'fa-solid fa-tree', 
                        title: 'Encrypted System Code', 
                        desc: 'Advanced encryption technology protects sensitive access information from unauthorized interception, ensuring secure communication and enhanced protection against tampering or security breaches.' 
                    },
                    { 
                        icon: 'fa-solid fa-chart-line', 
                        title: 'Memory – 1,100 Entries', 
                        desc: 'Large onboard memory stores up to 1,100 access records, enabling detailed tracking, monitoring, and auditing of user activities and system events over extended periods.' 
                    },
                    { 
                        icon: 'fa-solid fa-code-branch', 
                        title: 'Ability to Disable Lost Keys', 
                        desc: 'Lost or stolen keys can be quickly deactivated within the system, preventing unauthorized access and significantly improving overall security management and operational safety.' 
                    },
                    { 
                        icon: 'fa-solid fa-chart-simple', 
                        title: 'Options, Such as Time Delay or Dual Access Control', 
                        desc: 'Flexible security configurations, including timed access delays and dual authorization requirements, enhance protection for restricted areas and improve operational access management procedures.' 
                    }
                ],
                benefits: [
                    'Comprehensive planning expertise',
