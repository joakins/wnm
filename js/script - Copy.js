...
// Mobile dropdown functionality for vertical mega menu
function initMobileMenu() {
    if (window.innerWidth <= 768) {
        ...
        subDropdownToggles.forEach(toggle => {
            toggle.removeEventListener('click', handleSubDropdownClick);
            toggle.addEventListener('click', handleSubDropdownClick);
        });
    }
}
...
function handleSubDropdownClick(e) {
    e.preventDefault();
    const parent = this.closest('.mega-menu-item');
...
window.addEventListener('resize', function() {
    ...
    resizeTimer = setTimeout(function() {
        if (window.innerWidth > 768) {
            ...
            // Re-initialize mobile dropdowns
            const dropdownToggles = document.querySelectorAll('.dropdown-toggle');
            dropdownToggles.forEach(toggle => {
...
/* =========================================
   Mobile Menu JavaScript - Flyout System
   ========================================= */

document.addEventListener('DOMContentLoaded', function() {
    const mobileMenuToggle = document.querySelector('.mobile-menu-toggle');
    const mainNav = document.querySelector('.main-nav');
    const navItemsWithDropdown = document.querySelectorAll('.nav-item-with-dropdown');
    const megaMenuItems = document.querySelectorAll('.mega-menu-item');
    const allLinks = document.querySelectorAll('.main-menu a, .mega-menu-title, .submenu-level-3 a');
    ...
    // ==========================================
    // Mobile: Handle Main Dropdown (Services/Solutions)
    // ==========================================
    navItemsWithDropdown.forEach(item => {
        const link = item.querySelector('.nav-link-with-arrow');
    ...
    // ==========================================
    // Mobile: Handle Mega Menu Items (Categories)
    // ==========================================
    megaMenuItems.forEach(item => {
        const title = item.querySelector('.mega-menu-title');
    ...
    allLinks.forEach(link => {
        link.addEventListener('click', function(e) {
            // Only close menu on mobile when actual page links are clicked
